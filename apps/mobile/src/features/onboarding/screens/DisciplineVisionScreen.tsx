...
const DisciplineVisionScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const growthOpacity = useRef(new Animated.Value(0)).current;
  const growthTranslateY = useRef(new Animated.Value(SLIDE)).current;
  ...
  useEffect(() => {
    ...
    timers.push(
      setTimeout(() => {
        Animated.parallel([
          Animated.timing(morningOpacity, {
            toValue: 1,
            duration: 500,
            useNativeDriver: true,
          }),
          Animated.timing(morningTranslateY, {
            toValue: 0,
            duration: 500,
            useNativeDriver: true,
          }),
    ...
    timers.push(
      setTimeout(() => {
        Animated.parallel([
          Animated.timing(eveningOpacity, {
            toValue: 1,
            duration: 500,
            useNativeDriver: true,
          }),
          Animated.timing(eveningTranslateY, {
            toValue: 0,
            duration: 500,
            useNativeDriver: true,
          }),
    ...
    timers.push(
      setTimeout(() => {
        Animated.parallel([
          Animated.timing(growthOpacity, {
            toValue: 1,
            duration: 500,
            useNativeDriver: true,
          }),
          Animated.timing(growthTranslateY, {
            toValue: 0,
            duration: 500,
            useNativeDriver: true,
          }),
  ...
  return (
    <Animated.View style={{ flex: 1, opacity: screenOpacity }}>
      <ScreenContainer>
        <ProgressIndicator current={6} total={13} />
        ...
        <View style={styles.body}>
          ...
          <Animated.View
            style={{
              ...
              transform: [{ translateY: morningTranslateY }],
            }}
          >
            <Text style={styles.bodyText}>
              You wake up clear.{'\n'}You know exactly what matters.{'\n'}You
              act before distractions take control.
            </Text>
          </Animated.View>
          ...
          <Animated.View
            style={{
              ...
              transform: [{ translateY: eveningTranslateY }],
            }}
          >
            <Text style={styles.bodyText}>
          ...
          <Animated.View
            style={{
              ...
              transform: [{ translateY: growthTranslateY }],
            }}
          >
...
export default DisciplineVisionScreen;
