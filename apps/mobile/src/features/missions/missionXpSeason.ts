 ...
 * Season 1 begins January 2025; season number increments forever.
 *
 * (Separate from the 90-day Discipline Board / squad season helpers.)
 */

/** First month of Season 1 (local time): January 2025. */
...
/**
 * Current mission XP season index, starting at 1 for Jan–Apr 2025.
